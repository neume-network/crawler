...
export default class Zora {
    constructor(worker, config) {
        this.createdAtBlock = Zora.createdAtBlock; // First catalog song: https://etherscan.io/nft/0xabefbc9fd2f806065b4f3c237d4b59d9a97bcac7/1678
        ...
        this.nftToUid = async (nft) => `${this.chain}/${Zora.name}/${nft.erc721.address.toLowerCase()}/${nft.erc721.token.id}`;
